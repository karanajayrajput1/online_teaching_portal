...
{
    if(($_REQUEST['course_name'] == "") || ($_REQUEST['course_desc'] == "") || ($_REQUEST['author'] == "")
     ...
     || ($_REQUEST['course_sell_price'] == ""))
    {
        ...
        $sql = "INSERT INTO course(course_name, course_desc, course_author, course_img, course_duration, course_price, course_discout)
        VALUES('$course_name','$course_desc','$author','$img_folder','$course_duration','$course_org_price','$course_sell_price')";
