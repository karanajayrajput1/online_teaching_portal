        ...
        <div class="maincontent" style="position: absolute;
            ...
            if(isset($_GET['lesson_id']))
            {
                ...
                if($result->num_rows > 0)
                {
                    ...
                    echo '<iframe width="560" height="315" src="'.$row['lesson_link'].'" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe><br>';
                ...
                if($count>$total*0.75)
                {
                echo '<button class="button signup-button">Download Certificate</button>';
                }
            }
            ?>
        </div>
